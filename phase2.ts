...
async function getAllocators(page: Page, company: any) {
...
let writeCounter = 0;
async function writeToFile(_data: any, location: string, timeStamp: number) {
...
async function removeCompanyFromFile(filePath: string, company: any) {
  // Load the JSON file
